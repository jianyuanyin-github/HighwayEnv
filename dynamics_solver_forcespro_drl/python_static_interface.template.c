 ...
 *  - dynamics_solver_forcespro_drl
 *  - "include/dynamics_solver_forcespro_drl.h"
 *  - dynamics_solver_forcespro_drl_adtool2forces
 *  - dynamics_solver_forcespro_drl_interface
 *
...
#define SOLVER_FLOAT CONCATENATE(dynamics_solver_forcespro_drl, _float)
#define SOLVER_FUN_NAME CONCATENATE(dynamics_solver_forcespro_drl, _solve)

#include "include/dynamics_solver_forcespro_drl.h"

/* Header of external evaluation function */
solver_int32_default dynamics_solver_forcespro_drl_adtool2forces(SOLVER_FLOAT *x, SOLVER_FLOAT *y, SOLVER_FLOAT *l,
...
int dynamics_solver_forcespro_drl_interface(void *params, void *outputs, void *info, void *mem, FILE *fp) {
    return SOLVER_FUN_NAME(params, outputs, info, mem, fp, &dynamics_solver_forcespro_drl_adtool2forces);
}
