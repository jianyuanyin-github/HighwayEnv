% dynamics_solver_forcespro_drl - a fast solver generated by FORCESPRO v6.4.0
%
%   OUTPUT = dynamics_solver_forcespro_drl(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = dynamics_solver_forcespro_drl(PARAMS) returns additionally
...
%
%   [OUTPUT, EXITFLAG, INFO] = dynamics_solver_forcespro_drl(PARAMS) returns 
