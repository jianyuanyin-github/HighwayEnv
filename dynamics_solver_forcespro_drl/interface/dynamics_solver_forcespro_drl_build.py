...
sourcedir = os.path.join(os.getcwd(), "dynamics_solver_forcespro_drl", "src")
sourcefile_list = glob.glob(os.path.join(sourcedir, "*.c"))

# determine lib file
libdir = os.path.join(os.getcwd(), "dynamics_solver_forcespro_drl", "lib")
lib_opts = []
if sys.platform.startswith('win'):
	static_libformat = "dynamics_solver_forcespro_drl_static"
	shared_libformat = "dynamics_solver_forcespro_drl"
	lib_opts.append("/DLL")
else:
	static_libformat = "dynamics_solver_forcespro_drl"
	shared_libformat = "dynamics_solver_forcespro_drl"
...
objdir = os.path.join(os.getcwd(),"dynamics_solver_forcespro_drl","obj")
...
# create libraries
exportsymbols = ["dynamics_solver_forcespro_drl_solve", "dynamics_solver_forcespro_drl_internal_mem"]
try:
	os.chdir(objdir)
