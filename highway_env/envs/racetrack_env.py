...
class RacetrackEnvLarge(RacetrackEnv):
    ...
    def _make_road(self) -> None:
        ...
        # Add Lanes to Road Network - Straight Section (single lane only)
        net.add_lane("a", "b", lane)

        # 2 - Circular Arc #1 (single lane only)
        center1 = [200, -20]
        radii1 = 20
        net.add_lane(
            "b",
        ...
        # 3 - Vertical Straight (single lane only)
        ...
        # 4 - Circular Arc #2 (single lane only)
        center4 = [205, -60]
        radii4 = 15
        net.add_lane(
            "d",
        ...
        # 5 - Circular Arc #3 (single lane only)
        center5 = [170, -60]
        radii5 = 15
        net.add_lane(
            "e",
        ...
        # 9 - Circular arc 7, end (single lane only)
        # Since y2 = 0...
